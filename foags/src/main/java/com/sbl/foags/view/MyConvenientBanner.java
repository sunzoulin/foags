...
public class MyConvenientBanner<T> extends FrameLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.include_my_viewpager, this, true);
    ...
    public MyConvenientBanner setLayoutManager(RecyclerView.LayoutManager layoutManager) {
        viewPager.setLayoutManager(layoutManager);
        return this;
    }
    public MyConvenientBanner setPages(CBViewHolderCreator holderCreator, List<T> datas) {
        this.mDatas = datas;
    ...
    public MyConvenientBanner setCanLoop(boolean canLoop){
    ...
    public MyConvenientBanner setPointView(ViewGroup loPageTurningPoint) {
     ...
     */
    public MyConvenientBanner setPageIndicator(int[] page_indicatorId) {
     ...
     * @return
     */
    public MyConvenientBanner setOnPageChangeListener(OnPageChangeListener onPageChangeListener) {
     ...
     */
    public MyConvenientBanner setOnItemClickListener(final OnItemClickListener onItemClickListener) {
     ...
     * @return
     */
    public MyConvenientBanner setCurrentItem(int position, boolean smoothScroll) {
     ...
     * @return
     */
    public MyConvenientBanner setFirstItemPos(int position) {
     ...
     * @return
     */
    public MyConvenientBanner startTurning(long autoTurningTime) {
    ...
    public MyConvenientBanner startTurning() {
    ...
    static class AdSwitchTask implements Runnable {
        ...
        private final WeakReference<MyConvenientBanner> reference;

        AdSwitchTask(MyConvenientBanner convenientBanner) {
            this.reference = new WeakReference<MyConvenientBanner>(convenientBanner);
        }

        @Override
        public void run() {
            MyConvenientBanner convenientBanner = reference.get();
