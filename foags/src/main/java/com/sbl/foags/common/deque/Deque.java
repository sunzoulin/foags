...
interface Deque<E> extends Queue<E> {
     ...
     * differs fromStartVideoTalkToQuery {@link #pollFirst pollFirst} only in that it throws an
     ...
     * differs fromStartVideoTalkToQuery {@link #pollLast pollLast} only in that it throws an
     * exception if this deque is empty.
     *
     ...
     * <p/>
     * This method differs fromStartVideoTalkToQuery {@link #peekFirst peekFirst} only in that it
     ...
     * This method differs fromStartVideoTalkToQuery {@link #peekLast peekLast} only in that it
     * throws an exception if this deque is empty.
     *
     * @return the tail of this deque
     * @throws NoSuchElementException if this deque is empty
    ...
    /**
     * Pops an element fromStartVideoTalkToQuery the stack represented by this deque.  In other
