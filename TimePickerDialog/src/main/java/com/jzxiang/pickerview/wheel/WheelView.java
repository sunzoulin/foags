...
public class WheelView extends View {
    ...
    private Paint mPaintLineCenter, mPaintRectCenter;
    // Listeners
    ...
    private void initData(Context context) {
        ...
        mPaintLineCenter.setColor(0xfff1f1f1);
...
//        mPaintLineRight.setColor(0xffff4279);
...
//        mPaintLineRight.setStyle(Paint.Style.FILL);
        ...
        mPaintRectCenter.setColor(0xfff0565e);
        mPaintRectCenter.setAntiAlias(true);
        mPaintRectCenter.setStyle(Paint.Style.FILL);

        int mLineRightMar = context.getResources().getDimensionPixelSize(R.dimen.picker_line_mar);
    ...
    private void setConfig(PickerConfig config) {
...
//        mPaintRectCenter.setAlpha((int) (0.1 * 255));
    ...
    public void setShowLeftLine(boolean flag){
        this.isShowLeftLine = flag;
    }
...
//        centerDrawable.draw(canvas);
        if(isShowLeftLine){
            canvas.drawRect(0, center - offset, 8, center + offset, mPaintRectCenter);
        }
...
//        canvas.drawLine(x, mLineRightMar, x, getHeight() - mLineRightMar, mPaintLineRight);
    ...
    private void refreshTextStatus(View view, int index) {
