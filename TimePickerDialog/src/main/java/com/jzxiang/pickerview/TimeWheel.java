...
class TimeWheel {
    ...
    private void initView(View view) {
        ...
        switch (mPickerConfig.mType) {
            case ALL:
                year.setShowLeftLine(true);
                month.setShowLeftLine(false);
                day.setShowLeftLine(false);
                hour.setShowLeftLine(false);
                minute.setShowLeftLine(false);
                break;
            case YEAR_MONTH_DAY:
                year.setShowLeftLine(true);
                month.setShowLeftLine(false);
            ...
            case MONTH_DAY_HOUR_MIN:
                ...
                break;
            case DAY_HOUR_MIN:
                day.setShowLeftLine(true);
                hour.setShowLeftLine(false);
                minute.setShowLeftLine(false);
                Utils.hideViews(year, month);
                break;
            case HOURS_MINS:
                hour.setShowLeftLine(true);
                minute.setShowLeftLine(false);
